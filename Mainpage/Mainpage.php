...
<head>
    ...
    <meta name="keywords" content="autonomes Mini-Auto, ferngesteuertes Fahrzeug, Golfball-Suche, technologische Innovation, kleines Auto, Teamprojekt, Robotik, Projekt">
...
<div class="nav-bar">
    <div class="logo"><!-- logo eini tian -->
        <a href="Mainpage.php">
            <img id="nav-bar-logo" src="MainpageBilder/neulogo.jpg"
