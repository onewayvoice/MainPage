...
<body>
    <div class="nav-bar">
        <div class="logo"><!-- logo eini tian -->
            <a href="Mainpage.php">
                <img id="nav-bar-logo" src="nav_bar_logo.PNG" alt="Eine illustration eines Golfautos. Darunter steht noch das Wort Car.">
            </a>
        </div>
    ...
    <div id="container">
        ...
        <div class="title-bar"> <!-- titel mini text & erstes bild drinnen -->
            ...
            <div class="title-img-div">
                <img id="title-img" src="preview_hochkant.jpg" alt="text">
            </div>
        </div>
